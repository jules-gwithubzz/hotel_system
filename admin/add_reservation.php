...
$rooms  = $conn->query("SELECT room_id, room_number, room_type, price FROM rooms WHERE status='available' ORDER BY room_number");
...
<title>Add Reservation — Cool Waves Hotel</title>
